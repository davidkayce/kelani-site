  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.div className="w-full h-[300px] lg:h-[360px] bg-[linear-gradient(135deg,rgba(0,0,0,.9),rgba(0,0,0.2,0.8))] flex flex-col lg:flex-row overflow-hidden">
            <div
